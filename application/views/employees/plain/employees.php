    ...
    <body class="bootstrap-admin-with-small-navbar">
                        ...
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                <div class="head panel-heading">
                                    <div class="text-muted bootstrap-admin-box-title">Daftar Pegawai</div>
                                    <button class="xright btn btn-sm btn-default" id="addemployee">
                                        <i class="glyphicon glyphicon-plus"></i> Penambahan
                                    </button>
                                    <button class="xright btn btn-sm btn-default" id="importemployee">
                                ...
                                <div class="bootstrap-admin-panel-content">
                                    <table class="table table-striped table-bordered" id="tblemployee">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                <td title='<?php echo $info;?>'><?php echo $obj->id;?></td>
                                                <td title='<?php echo $info;?>'><?php echo $obj->nname;?></td>
                                                <td title='<?php echo $info;?>'><?php echo $obj->department;?></td>
                                                <td class="center">
                                                <div class="btn-group">
                                                    <button class="btn">Action</button>
                                                    <button data-toggle="dropdown" class="btn dropdown-toggle"><span class="caret"></span></button>
                                                    <ul class="dropdown-menu">
                                                        <li><a href="../employees/edit/<?php echo $obj->id;?>">Edit</a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="../employees/remove/<?php echo $obj->id;?>">Hapus</a></li>
                                                    </ul>
                                                </div>
                                                </td>
                                            </tr>
        ...
        <script type="text/javascript">
            ...
            $("#importemployee").click(function(){
                window.location.href = "/employees/import";
            });
        </script>
    </body>
</html>
