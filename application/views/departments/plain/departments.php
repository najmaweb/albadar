...
<html>
    ...
    <body class="bootstrap-admin-with-small-navbar">
                                    ...
                                    <table class="table table-striped table-bordered" id="tblDupsbgroup">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX">
                                                ...
                                                <td class="rightaligned number"><?php echo number_format($obj->amount);?></td>
                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="../Dupsbgroups/edit/<?php echo $obj->id;?>">Edit</a></li>
                                                        <li class="divider"></li>
                                                        <li><a href="../Dupsbgroups/remove/<?php echo $obj->id;?>">Hapus</a></li>
                                                    </ul>
                                                </div>
                                                </td>
                                            </tr>
        ...
        <script type="text/javascript">
            ...
            $("#addDupsbgroup").click(function(){
                window.location.href = "/Dupsbgroups/add";
            });
        </script>
    </body>
</html>
