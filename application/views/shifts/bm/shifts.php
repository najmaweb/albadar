			...
			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						...
						<div class="box-icon">
							<a href="/<?php echo $cname;?>/import" class="btn-setting"><i class="halflings-icon import"></i></a>
							<a href="#" class="btn-setting"><i class="halflings-icon wrench"></i></a>
							<a href="/<?php echo $cname;?>/add" class=""><i class="halflings-icon plus"></i></a>
						</div>
					</div>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <?php foreach($objs as $obj){?>
							<tr>
								...
								<td class="center"><?php echo $obj->starthour;?></td>
								<td class="center"><?php echo $obj->endhour;?></td>
