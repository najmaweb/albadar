					...
					<div class="box-content">
						<form class="form-horizontal" action="/<?php echo $parent;?>/update" method="post">
						  <fieldset>
							...
							<div class="control-group">
								<label class="control-label" for="focusedInput">Start Hour</label>
								<div class="controls">
								  <input class="input-xlarge" id="starthour" name="starthour" type="text" value="<?php echo $obj->starthour;?>" placeholder="Start Hour">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="focusedInput">End Hour</label>
								<div class="controls">
									<input class="input-xlarge" id="endhour" name="endhour" type="text" value="<?php echo $obj->endhour;?>" placeholder="End Hour">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="focusedInput">Keterangan</label>
								<div class="controls">
									<input class="input-xlarge" id="description" name="description" type="text" value="<?php echo $obj->description;?>" placeholder="Keterangan">
								</div>
							</div>
